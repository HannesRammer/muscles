...
function to_scale_or_not_to_scale() {
    ...
    if (true || document.querySelector(".grid_parent") !== null) {
...
let mouse_animation = {
    start:function (){
        let tags =["balance","cardio","cooldown","stretching","warmup","pilates"];
        // let tags =["balance","cardio","cooldown","strength","stretching","warmup","yoga","pilates","bodyweight"];
        $(document).scrollTop(0);
        mouse_animation.go_to_dom_element("#tags ."+tags[getRandomInt(tags.length)]);
        // mouse_animation.go_to_dom_element();
    },
    go_to_dom_element:function (css_identifyer){
        let element = document.querySelector(css_identifyer);
        element.scrollIntoView();
        setTimeout(function (){
            let position = $(element).offset();
            let scroll_top=$(document).scrollTop();
            $("#mouse_cursor").css("left",position["left"]+31);

            $("#mouse_cursor").css("top",position["top"]-scroll_top+11);
            setTimeout(function (){element.click();},600);
